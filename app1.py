...
from combined_verification import solve_document_ocr
...
def verify_document():
    ...
    try:
        ...
        if document_type == 'kenyan_id' or document_type == 'auto':
            ...
            id_result = solve_document_ocr(image_paths)
            # Combine results from multiple pages if needed
            results['kenyan_id'] = combine_kenyan_id_results(id_result)
        ...
        if document_type == 'certificate' or document_type == 'auto':
            # Analyze as Certificate
            cert_result = solve_document_ocr(image_paths)
